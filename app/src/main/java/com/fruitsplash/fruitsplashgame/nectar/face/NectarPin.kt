...
internal data class NectarCard(
    val artWidth: Int,
    val artHeight: Int,
    val bottom: Float,
) {
    fun projectInto(frameWidth: Dp, frameHeight: Dp): NectarBand {
...
internal data class NectarBand(
    val cardBottom: Dp,
    val artBottom: Dp,
    val frameHeight: Dp,
) {
...
internal object NectarArtMetrics {
    val InvitePortrait = NectarCard(1080, 2400, 0.64f)
    val InviteLandscape = NectarCard(2400, 1080, 0.68f)
    val OfflinePortrait = NectarCard(1080, 2400, 0.66f)
    val OfflineLandscape = NectarCard(2400, 1080, 0.70f)
}
