package com.fruitsplash.fruitsplashgame.nectar.id
...
object NectarBrand {
    ...
    val configEndpoint: String get() = NectarBytes.configEndpoint()
    val attributionKey: String get() = NectarBytes.attributionKey()
    val messagingProject: String get() = NectarBytes.messagingProject()
