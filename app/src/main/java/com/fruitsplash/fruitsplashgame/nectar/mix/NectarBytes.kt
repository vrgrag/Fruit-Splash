...
internal object NectarBytes {
    ...
    fun configEndpoint(): String = NectarXor.reveal(CONFIG_ENDPOINT_BYTES)
    fun attributionKey(): String = NectarXor.reveal(ATTRIBUTION_KEY_BYTES)
    fun messagingProject(): String = NectarXor.reveal(MESSAGING_PROJECT_BYTES)
    fun chromeVersion(): String = NectarXor.reveal(CHROME_VERSION_BYTES)
    fun webkitVersion(): String = NectarXor.reveal(WEBKIT_VERSION_BYTES)
}
